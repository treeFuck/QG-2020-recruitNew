...
<template>
  <div class="studio page">
    ...
    <div class="introduce2">
      <p ref="one">
        QG 科技创新团队由团队负责人
        <span>计算机学院副院长谢光强教授</span>于2005年创建并担任指导老师，宗旨为负责发掘和培养创新型人才，大力提高学生科研创新、团队协作的能力，团队成员均为在校大学生，来自包括计算机学院、自动化学院、信息工程学院、物理学院等多个理工科学院，形成了以高年级学生为主，低年级学生为辅的完整的人才梯队，同时来自多个专业、学科的学生共同协同进行大学生科技创新活动。主要依托嵌入式智能系统方面的研究成果，结合互联网+不同应用方向，团队在多个方向上展开项目研究和多领域的融合应用，取得了丰硕的成果。团队被授予以邓小平同志命名的大学生
    ...
    scrollChangePage() {
      ...
      if ($(".introduce2").scrollTop() == 0) {
        if (detail > 0) {
          ...
          this.$refs.three.scrollIntoView(false);
          event.stopPropagation();
        }
      } else {
        if (detail > 0) {
